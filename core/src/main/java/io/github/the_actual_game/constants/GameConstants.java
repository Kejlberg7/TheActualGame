...
public class GameConstants {
    ...
    public static final float MIN_SHOOTING_INTERVAL = 0.1f;  // Fastest shooting (was 0.05f)
    public static final float MAX_SHOOTING_INTERVAL = 0.8f;  // Slowest shooting (was 0.5f)
    ...
    // Gate constants
    public static final float GATE_WIDTH = PANE_WIDTH * 0.8f; // 80% of pane width for better visibility
